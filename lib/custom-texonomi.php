...
function themename_custom_texonomi() {
    $labels = array(
    ...
    $arrgs = array(
		...
		'rewrite' => ['slug' => 'texonomy']
    );


    register_taxonomy( 'themenaem_custom_texonomi', ['themename_custom'], $arrgs);
}

add_action( 'init', 'themename_custom_texonomi');