<div class="c-post-author u-margin-button-20">
    <h2 class="u-screen-reader-text"><?php esc_html_e( 'About The Author', 'themename'); ?></h2>
    <?php
    ...
    <div class="c-post-author__content">
        ...
        <div class="c-post-author__info">
            <a href="<?php echo esc_url($author_posts_url) ?>">
                <?php 
                   printf(
                    esc_html__(_n('%s Post', '%s Posts', $author_posts, 'themename')),
        ...
        <div class="c-post-author__desc">
            <?php echo esc_html__( $author_description, 'themename' ); ?>
        </div>
    </div>
